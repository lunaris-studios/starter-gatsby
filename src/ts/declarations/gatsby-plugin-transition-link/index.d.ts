/**
 * Acknowledgements to @crutchcorn for the types:
 * https://github.com/crutchcorn/gatsby-plugin-transition-link/blob/master/index.d.ts
 */
...
declare module "gatsby-plugin-transition-link" {
	...
	class TransitionState extends Component<TransitionStateFACCProps> {}
	...
	function useTriggerTransition<State, LinkState>(
		defaultOptions: UseTriggerTransitionOptions<State, LinkState>
	): programmaticallyTriggerTransition<State, LinkState>;

	function useTransitionState(): TransitionStateProps;

	export interface TransitionLinkProps<State = any>
