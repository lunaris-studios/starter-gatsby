...
declare namespace GatsbyTypes {
	...
	enum SitePageFieldsEnum {
		...
		pluginCreator___pluginOptions___emitSchema____xsrcxapixgatsbyxintrospectionxjson = "pluginCreator.pluginOptions.emitSchema._xsrcxapixgatsbyxintrospectionxjson",
		pluginCreator___pluginOptions___emitSchema____xsrcxapixgatsbyxschemaxgraphql = "pluginCreator.pluginOptions.emitSchema._xsrcxapixgatsbyxschemaxgraphql",
		pluginCreator___pluginOptions___emitPluginDocuments____xsrcxapixgatsbyxpluginxdocumentsxgraphql = "pluginCreator.pluginOptions.emitPluginDocuments._xsrcxapixgatsbyxpluginxdocumentsxgraphql",
	...
	enum SitePluginFieldsEnum {
		...
		pluginOptions___emitSchema____xsrcxapixgatsbyxintrospectionxjson = "pluginOptions.emitSchema._xsrcxapixgatsbyxintrospectionxjson",
		pluginOptions___emitSchema____xsrcxapixgatsbyxschemaxgraphql = "pluginOptions.emitSchema._xsrcxapixgatsbyxschemaxgraphql",
		pluginOptions___emitPluginDocuments____xsrcxapixgatsbyxpluginxdocumentsxgraphql = "pluginOptions.emitPluginDocuments._xsrcxapixgatsbyxpluginxdocumentsxgraphql",
	...
	type SitePluginPluginOptionsEmitPluginDocuments = {
		readonly _xsrcxapixgatsbyxpluginxdocumentsxgraphql: Maybe<Scalars["Boolean"]>;
	};

	type SitePluginPluginOptionsEmitPluginDocumentsFilterInput = {
		readonly _xsrcxapixgatsbyxpluginxdocumentsxgraphql: Maybe<BooleanQueryOperatorInput>;
	};

	type SitePluginPluginOptionsEmitSchema = {
		readonly _xsrcxapixgatsbyxintrospectionxjson: Maybe<Scalars["Boolean"]>;
		readonly _xsrcxapixgatsbyxschemaxgraphql: Maybe<Scalars["Boolean"]>;
	};

	type SitePluginPluginOptionsEmitSchemaFilterInput = {
		readonly _xsrcxapixgatsbyxintrospectionxjson: Maybe<BooleanQueryOperatorInput>;
		readonly _xsrcxapixgatsbyxschemaxgraphql: Maybe<BooleanQueryOperatorInput>;
	};
